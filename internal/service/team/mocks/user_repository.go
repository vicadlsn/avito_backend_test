...
// Upsert provides a mock function with given fields: ctx, user, teamName
func (_m *UserRepository) Upsert(ctx context.Context, user domain.TeamMember, teamName string) error {
	ret := _m.Called(ctx, user, teamName)
